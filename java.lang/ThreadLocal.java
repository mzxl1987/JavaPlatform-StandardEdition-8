...
public class ThreadLocal<T> {
    ...
    public T get() {
        ...
        ThreadLocalMap map = getMap(t);                                     // 根据当前线程获取Map
        if (map != null) {
        ...
        return setInitialValue();                                            // 返回 null
    }
    ...
    private T setInitialValue() {
        T value = initialValue();                                           // 初始化一个null
        Thread t = Thread.currentThread();
        ThreadLocalMap map = getMap(t);                                     // 获取map
        if (map != null)
            map.set(this, value);                                           // 设置value
        else
            createMap(t, value);                                            // 如果没有map,创建Map并赋值
     ...
     *        this thread-local.
     */
    public void set(T value) {                                             // 同setInitialValue()
        Thread t = Thread.currentThread();
     ...
     */
    void createMap(Thread t, T firstValue) {                           // 创建Map并赋值
